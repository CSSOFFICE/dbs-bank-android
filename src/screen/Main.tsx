...
const images = [
    { id: 1, src: require('../images/test/screen1.webp'), title: 'Open the digibank app, tap on PayNow and login.' },
    { id: 2, src: require('../images/test/screen2.webp'), title: 'Select ‘Paynow’ from the smart shortcuts' },
    { id: 3, src: require('../images/test/screen3.webp'), title: 'Key in the Mobile No. of the recipient' },
    { id: 4, src: require('../images/test/screen4.webp'), title: 'Key in the amount to transfer and tap "Next' },
    { id: 5, src: require('../images/test/screen5.webp'), title: 'Review the transfer and select Transfer now' },
    { id: 6, src: require('../images/test/screen6.webp'), title: 'Your payment is successful!' }
];
...
const Main = ({ navigation }: any) => {
    ...
    const [placedImages, setPlacedImages] = useState([
        { id: 1, src: null, title: 'Open the digibank app,\ntap on PayNow and login.' },
        { id: 2, src: null, title: "Select \n 'PayNow to \n Mobile'." },
        { id: 3, src: null, title: "Key in the recipient's \n mobile \n number and \n tap 'Next'." },
        { id: 4, src: null, title: "Key in the amount to \n transfer \n and tap \n 'Next'." },
        { id: 5, src: null, title: "Review the transfer details and tap \n 'Transfer Now'." },
        { id: 6, src: null, title: 'Your \n transfer is  \n now \n complete!' }
    ]);
    ...
    return (
        <View style={styles.content}>
                    ...
                    <View key={index} style={styles.column}>
                        {image.src ? (
                            ...
                            <View style={{ marginTop: 70 }}>
                                <Text style={{ fontSize: 30, color: 'black', fontFamily: 'Raleway-Bold', textAlign: 'center',  }}>Step {index + 1} :</Text>
            ...
            <View style={{ marginVertical: 10 }}>
                <Text style={styles.heading}>What are the steps to make {'\n'}a PayNow funds transfer?
                </Text>
                <Text style={styles.subHeading}>Tap the screens in the right order</Text>
            </View>
            ...
            {(showCorrectGif || showIncorrectGif) && (
                <View style={styles.inactivityImageContainer}>
                    ...
                    <FastImage
                        source={showCorrectGif ? require('../images/rightgif.gif') : require('../images/wronggif.gif')}
                        style={styles.gif}
                        resizeMode="contain"
                    />
                </View>
            ...
            {showInactivityImage && (
                <View style={styles.inactivityImageContainer}>
                    <FastImage
                        source={require('../images/hint.gif')}
